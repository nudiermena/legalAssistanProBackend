#!/usr/bin/env python3
"""
Simple Headless Browser Debug
Non-interactive version that captures screenshots and analyzes content
"""
...
class SimpleHeadlessDebug:
    """Simple headless browser debug for Constitutional Court"""
    ...
    async def debug_page_content(self):
        ...
        try:
            ...
            await self.try_interactive_search()
...
async def main():
    """Main debug function"""
    try:
        async with SimpleHeadlessDebug() as scraper:
